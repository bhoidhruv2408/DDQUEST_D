// syllabus.js – Semester 1 Syllabus Viewer
        ...
        if (syllabusItems.length === 0) {
            syllabusGrid.innerHTML = `
                <div class="empty-state">
                    ...
                    <p>Check back later for semester 1 syllabus.</p>
                </div>
            `;
            return;
        }
    ...
    items.forEach(item => {
        ...
        html += `
            <div class="syllabus-card" data-id="${item.id}">
                ...
                <p class="syllabus-description">${item.description || 'Semester 1 syllabus document.'}</p>
