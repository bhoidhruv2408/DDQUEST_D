// syllabus.js – Semester 5 Syllabus (fully working)
...
async function loadSyllabus() {
    ...
    console.log('📥 Fetching syllabus materials for semester 5...');
    ...
    try {
        ...
        console.log(`📌 After semester 5 filter: ${filteredBySemester.length} syllabus items remain.`);
        ...
        if (filtered.length === 0) {
            syllabusGrid.innerHTML = `
                <div class="empty-state">
                    ...
                    <h3>No syllabus for semester 5</h3>
    ...
    items.forEach(item => {
        ...
        html += `
            <div class="syllabus-card" data-id="${item.id}">
                ...
                <p class="syllabus-description">${item.description || 'Semester 5 syllabus document.'}</p>
